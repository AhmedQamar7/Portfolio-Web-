            ...
            <div className="flex flex-col sm:flex-row mt-10">
              <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                ...
                <div className="flex flex-col items-center text-center justify-center ml-2 font-normal">
                  <h2 className="font-medium title-font mt-4 text-orange-500 text-lg font-def">
                    Muhammad Ahmed
                  </h2>
              ...
              <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-orange-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                <div className="title-font sm:text-4xl text-5xl text-center mb-4 text-orange-500 font-def font-bold">
                  About Me
